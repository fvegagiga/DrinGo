...
class RemoteCocktailImageDataLoader {
    ...
    func loadImageData(from url: URL, completion: @escaping (CocktailImageDataLoader.Result) -> Void) {
...
class RemoteCocktailImageDataLoaderTests: XCTestCase {
    ...
    private func expect(_ sut: RemoteCocktailImageDataLoader, toCompleteWith expectedResult: CocktailImageDataLoader.Result, when action: () -> Void, file: StaticString = #filePath, line: UInt = #line) {
        let url = URL(string: "https://a-given-url.com")!
