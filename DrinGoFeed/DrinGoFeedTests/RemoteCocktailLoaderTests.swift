...
class RemoteCocktailLoaderTests: XCTestCase {
    ...
    private func expect(_ sut: RemoteCocktailLoader, toCompleteWith result: RemoteCocktailLoader.Result, when action: () -> Void, file: StaticString = #filePath, line: UInt = #line) {
