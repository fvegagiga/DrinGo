...
class CocktailImageDataLoaderCacheDecorator: CocktailImageDataLoader {
    ...
    init(decoratee: CocktailImageDataLoader, cache: CocktailImageDataCache) {
...
class CocktailImageDataLoaderCacheDecoratorTests: XCTestCase, CocktailImageDataLoaderTestsCase {
    ...
    private func makeSUT(cache: CacheSpy = .init(), file: StaticString = #file, line: UInt = #line) -> (sut: CocktailImageDataLoader, loader: CocktailImageDataLoaderSpy) {
        ...
        let sut = CocktailImageDataLoaderCacheDecorator(decoratee: loader, cache: cache)
        trackForMemoryLeaks(loader, file: file, line: line)
        trackForMemoryLeaks(sut, file: file, line: line)
        return (sut, loader)
    }
    
    private class CacheSpy: CocktailImageDataCache {
        ...
        func save(_ data: Data, for url: URL, completion: @escaping (CocktailImageDataCache.Result) -> Void) {
